...
class HappyPlaylistPage extends StatelessWidget {
  Function(Music, {bool stop, bool isPlaying}) _miniPlayer;
  HappyPlaylistPage(this._miniPlayer, {super.key});
  ...
  Widget createMusicList(BuildContext context, String label) {
    List<Music> musicList = HappyPlaylist.getHappyMusic();
    return Padding(
        ...
        Container(
          child: Column(
              ...
              children: [
                ...
                createMusicList(context, 'Happy Playlist'),
              ]),
          decoration: BoxDecoration(
